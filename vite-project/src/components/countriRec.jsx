...
function ContriRec(props) {
  ...
  const listrecipes = async () => {
    try {
      ...
      // filter state-based recipes
      return recipesData.filter(recipe =>
        recipe.state &&
        recipe.state.toLowerCase() === props.sta.toLowerCase()
      );
    ...
    <div>
      {loading ? (
        ...
        <div>
          ...
          {/* Filters */}
          <div className="sticky top-50 cssbg mb-6 flex flex-wrap gap-8 border-b border-gray-300 shadow-sm">
